	...
	foreach(@kierunki){
		if ( $_ eq $pozycjaGracza ){
			...
			if($indeks == 1){
				...
				if ($odzywkiwypowiedziane{0} < 2 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&  $ileD > 3 && $ileD > $ileC && $ileD >= $ileH && $ileD >= $ileS){$propozycja = 2;} # 1 karo				
				if ($odzywkiwypowiedziane{0} < 3 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&   $ileH > 3 && $ileH > $ileC && $ileH > $ileD && $ileH >= $ileS){$propozycja = 3;} # 1 kier
				if ($odzywkiwypowiedziane{0} < 4 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&  $ileS > 3 && $ileS> $ileC && $ileS > $ileD && $ileS > $ileH){$propozycja = 4;} # 1 pik
				if ($odzywkiwypowiedziane{0} < 3 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&  $ileH == 5 && $ileH> $ileC && $ileH >= $ileD && $ileH > $ileS){$propozycja = 3;} # 1 kier	
				if ($odzywkiwypowiedziane{0} < 3 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&   $ileS == 5 && $ileS> $ileC && $ileS > $ileD && $ileS >= $ileH){$propozycja = 4;} # 1 pik	
				if ($odzywkiwypowiedziane{0} < 3 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&   $ileH > 3 && $ileH > $ileC && $ileH > $ileD && $ileH >= $ileS){$propozycja = 3;} # 1 kier
				if ($odzywkiwypowiedziane{0} < 2 && $punktyPrzeliczeniowe >5 && $punktyPrzeliczeniowe < 10 &&   $ileH > 3 && $ileH > $ileC && $ileH > $ileD && $ileH >= $ileS){$propozycja = 6;} # 2 trefl
				# podniesienia bilansowe
				if ($odzywkiwypowiedziane{0} < 2 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe < 12 &&  $ileD > 3 && $ileD > $ileC && $ileD >= $ileH && $ileD >= $ileS){$propozycja = 7;} # 2 karo				
				...
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 1 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe <16){$propozycja=15;} # 3 BA
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 1 && $punktyPrzeliczeniowe >15 && $punktyPrzeliczeniowe <18){$propozycja=20;} # 4 BA
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 1 && $punktyPrzeliczeniowe >17 && $punktyPrzeliczeniowe <20){$propozycja=30;} # 6 BA
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 1 && $punktyPrzeliczeniowe >19 && $punktyPrzeliczeniowe <22){$propozycja=25;} # 5 BA
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 1 && $punktyPrzeliczeniowe >21){$propozycja=35;} # 7 BA
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && ($ileS == 4 || $ileS == 5 || $ileH == 4 || $ileH == 5)){$propozycja = 6;} #2 trefl - Stayman
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe <8 && $ileD > 4){$propozycja = 7;} # 2 karo
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe <8 && $ileH > 4){$propozycja = 8;} # 2 kier
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe <8 && $ileS > 4){$propozycja = 9;} # 2 pik
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $ileC > 4){$propozycja = 11;} # 3 trefl
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $ileD > 4){$propozycja = 12;} # 3 karo
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $ileH > 4){$propozycja = 13;} # 3 kier
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $ileS > 4){$propozycja = 14;} # 3 pik
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe <16 && $ileC > 5){$propozycja = 15;} # 4 kier
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe <16 && $ileD > 5){$propozycja = 15;} # 4 pik
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe <16 && $ileH > 5){$propozycja = 18;} # 4 kier
				if ($odzywkiwypowiedziane{0} == 5 && $rekazrownowazona == 0 && $punktyPrzeliczeniowe >9 && $punktyPrzeliczeniowe <16 && $ileS > 5){$propozycja = 19;} # 4 pik
				
				# odpowiedzi na 2 trefl
				if ($odzywkiwypowiedziane{0} == 6) {
				...
				if ($odzywkiwypowiedziane{0} > 15){$propozycja = 36;}
			}
